...
function tryExec(c) {
  try { execSync(c, { stdio: "pipe", timeout: 3000 }); return true; } catch { return false; }
}

export function detectTools() {
  return {
    claude:     existsSync(join(HOME, '.claude')) || existsSync(join(ROAM, 'Claude')) || tryExec('claude --version'),
